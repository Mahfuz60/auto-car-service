...
import TestimonialCart from '../Home/TestimonialCart/TestimonialCart';
    ...
    return (
      ...
      <div className="container ">
        <div className="ms-4 text-center">
          ...
          Our professionals will perform diagnostic tests, fluid flush and fills, engine replacement,  <br /> oil changes, and total vehicle overhauls.
          </p>
        </div>
                   ...
                   <div className="card-deck mt-5">
                        <div className="row ">
                            ...
                            <TestimonialCart review={review} key={review.name}>
                            </TestimonialCart>
                        ))} */}

                        <TestimonialCart review={review} ></TestimonialCart>
                        </div>
                    </div>
                   </div>
